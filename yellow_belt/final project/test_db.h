...
void TestsMyCustom()
{
...

    {
        ...
        AssertEqual("2019-12-2", db.Last({ 2019, 12, 2 }), " My test 7");

        AssertEqual("2019-12-3", db.Last({ 2019, 12, 4 }), " My test 8");

        db.Add({ 2019, 12, 3 }, "m");
        AssertEqual("2019-12-3", db.Last({ 2019, 12, 3 }), " My test 9");
...

    {
        ...
        AssertEqual("2019-12-1", db.Last({ 2019, 12, 1 }), " My test 20");

        db.Add({ 2019, 12, 1 }, "b");
        AssertEqual("2019-12-1", db.Last({ 2019, 12, 1 }), " My test 21");
...
void TestDatabase() {
    ...
    // Last
    {
        ...
        db.Add(d1, "e1");
        db.Add(d2, "e2");
        AssertEqual(db.Last(d), "2018-12-22", "Db Last 1");
        Date d3(2018, 12, 24);
        db.Add(d3, "e3");
        AssertEqual(db.Last(d), "2018-12-24", "Db Last 2");
        ...
        AssertEqual(db.Last(d), "2018-12-22", "Db Last 4");

        AssertEqual(db.Last(d1), "2019-1-2", "Db Last 5");
        db.Add(d2, "e4");        
        AssertEqual(db.Last(d2), "2018-12-22", "Db Last 6");
    }
